describe('클릭이벤트 및 뷰를 담당하는 클래스입니다.', ()=>{
  it('viewManager의 인자로 textManager의 인스턴스가 잘 전달되는지 확인합니다.', ()=>{
    ...
    // textManager가 null값이기에, Error를 던질 것임을 예상함.
  })

  it('viewManger의 인자로 HTML요소들이 잘 전달되는지 확인합니다', ()=> {
  ...
  it('click이벤트가 발생했을 경우 changeValue 함수가 실행되는지 확인합니다', ()=>{
