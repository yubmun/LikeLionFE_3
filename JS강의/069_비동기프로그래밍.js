...
// await은 탑레벨 await, await을 작성하지 않으면, console.log가 먼저 작성된다?

/**
 * function -> await 을 쓰면 안된다.
 * async function-> await을 쓸 수 있다.
 * 
 * await을 통해서 비동기 프로그래밍을 할 수 있다.
 * 예외적으로, 전역객체에서 선언하는 await이 밖에 감싸여진 함수 없이 사용될수 있는 것을 top-level-await이라 하고, 이건 작동할 수 있다. (생긴지 얼마 안됐다)
 */
